define(function (require) {
	...
	view.unit = 5;
	view.part = 1;
	view.description = "3 Red Triangles";
	var amountHD, colorHD, shapeHD;
	var cue = {};
	...
	var makeCue = function () {
		...
		var displayColor;
		if (color === "brown") {
			displayColor = "saddleBrown";
		} else if (color === "pink") {
			displayColor = "deepPink";
		...
		cue = {
text: amount.toString() + " " + color + " " + (amount === 1 ? shape : shape + "s"),
			render: function () {
